...
OUTPUT_FILE = "dpo_data/dpo_pairs.jsonl"
RATE_LIMIT_DELAY = 5.0  # 12 Requests per minute
...
def main():
    ...
    print(f"Found {len(processed_prompts)} already processed.")
    
    prompts_to_process = [p for p in prompts if p not in processed_prompts][:300]
